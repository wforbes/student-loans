...
export default function AddLoanForm({ done, servicerFormOpen, setServicerFormOpen }: AddLoanFormProps) {
	const { mutate: addLoan } = useAddLoanMutation();
	...
	const _submit = (data: z.infer<typeof FormSchema>) => {
		//console.log(`AddLoanForm _submit: ${JSON.stringify(data)}`)
		addLoan({
